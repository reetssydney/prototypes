...
<html lang="en">
<head>
    <title>Code coverage report for src/mixins/AccessKeyedElement.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/mixins/</a> AccessKeyedElement.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">74996×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">74996×</span>
<span class="cline-any cline-yes">74996×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">74996×</span>
<span class="cline-any cline-yes">72886×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">74996×</span>
<span class="cline-any cline-yes">74996×</span>
<span class="cline-any cline-yes">1924×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">16688×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16688×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7168×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9520×</span>
<span class="cline-any cline-no">&nbsp;</span>
...
OO.ui.mixin.AccessKeyedElement.prototype.setAccessKeyedElement = function ( $accessKeyed ) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.$accessKeyed ) {
<span class="cstat-no" title="statement not covered" >		this.$accessKeyed.removeAttr( 'accesskey' );</span>
	}
&nbsp;
...
&nbsp;
	if ( this.accessKey !== accessKey ) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.$accessKeyed ) {
<span class="cstat-no" title="statement not covered" >			if ( accessKey !== null ) {</span>
<span class="cstat-no" title="statement not covered" >				this.$accessKeyed.attr( 'accesskey', accessKey );</span>
			} else {
<span class="cstat-no" title="statement not covered" >				this.$accessKeyed.removeAttr( 'accesskey' );</span>
			}
		}
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if ( this.updateTitle ) {
			this.updateTitle();
		}
	}
&nbsp;
...
&nbsp;
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( $.fn.updateTooltipAccessKeys &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >$.fn.updateTooltipAccessKeys.getAccessKeyLabel </span>) {
<span class="cstat-no" title="statement not covered" >		accessKey = $.fn.updateTooltipAccessKeys.getAccessKeyLabel( this.$accessKeyed[ 0 ] );</span>
	} else {
